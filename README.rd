#Masked AES implementation for Virginia Tech
...
##Byte-Masked-AES
###Scheme
The byte-wise implementation follows a well-known textbook example scheme, whose details can be found in the [scheme introduction](Byte-Masked-AES/Scheme_Introduction.rd).

###Scheme Adaption 
All the code changes during the adaption procedure are documented in the [Revision Notes] (Byte-Masked-AES/Revision_Notes.rd)
...
Corresponding experiment setups can be found in [Setup.rd](Byte-Masked-AES/TVLA-Test/Setup.rd) .

Attention: interpreting TVLA results might be quite tricky. We strongly recommend readers to read our [Caution Notes](Byte-Masked-AES/TVLA Test/Caution-Notes.rd)
